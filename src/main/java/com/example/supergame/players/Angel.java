...
public class Angel extends Player {
    ...
    Angel(String name, int maxHp, int currentHp, int maxDemonBlood, int currentDemonBlood, int accuracy, Inventory inventory, Spell[] spells, MissionInventory missionInventory) {
